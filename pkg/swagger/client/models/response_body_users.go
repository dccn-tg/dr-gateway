...
func (m *ResponseBodyUsers) validateUsers(formats strfmt.Registry) error {
...
func (m *ResponseBodyUsers) contextValidateUsers(ctx context.Context, formats strfmt.Registry) error {
