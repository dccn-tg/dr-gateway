...
func (m *ResponseBodyCollections) validateCollections(formats strfmt.Registry) error {
...
func (m *ResponseBodyCollections) contextValidateCollections(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseBodyCollections) UnmarshalBinary(b []byte) error {
	var res ResponseBodyCollections
