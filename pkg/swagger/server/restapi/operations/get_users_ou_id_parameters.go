...
// GetUsersOuIDParams contains all the bound params for the get users ou ID operation
...
func (o *GetUsersOuIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetUsersOuIDParams) validateID(formats strfmt.Registry) error {

	if err := validate.EnumCase("id", "path", o.ID, []interface{}{"dcc", "dccn", "dcn", "dcmn"}, true); err != nil {
		return err
	}
