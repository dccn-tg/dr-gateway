...
// GetCollectionsProjectIDParams contains all the bound params for the get collections project ID operation
...
func (o *GetCollectionsProjectIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
