...
// GetCollectionsOuIDParams contains all the bound params for the get collections ou ID operation
...
func (o *GetCollectionsOuIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetCollectionsOuIDParams) validateID(formats strfmt.Registry) error {
